...
<body class="bg-gray-50 font-family-karla">
            ...
            <nav>
                ...
                <li>
                        <x-dropdown align="left" >
                            <x-slot name="trigger">
                                <button class="hover:text-gray-200 hover:underline px-4 flex items-center">
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            <a class="font-bold text-gray-800 uppercase hover:text-gray-700 text-4xl lg:text-5xl" href="#">
                {{\App\Models\TextWidget::getTitle('header')}}           
            </a>
            <p class="text-lg text-gray-600">
                {{\App\Models\TextWidget::getTitle('sub-header')}}
            </p>
        </div>
    </header>
    ...
    <div class="container mx-auto flex flex-wrap py-6">
        {{-- render post section and sidebar section --}}
        {{$slot}}
    ...
    <footer class="w-full border-t bg-white pb-12">
        ...
        <div class="w-full container mx-auto flex flex-col items-center">
            ...
            <div class="uppercase">&copy; Rahmadahya.aja</div>
        </div>
    </footer>

    <div class="w-full py-5 bg-blue-800 shadow">
    </div>
